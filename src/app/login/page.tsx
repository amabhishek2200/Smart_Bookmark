            ...
            >
                    ...
                    <div className="h-6 overflow-hidden relative w-full flex justify-center">
                        <AnimatePresence mode='wait'>
                            ...
                            >
                                ...
                                <span className="text-sm uppercase">{features[featureIndex]}</span>
                                <Sparkles className="w-3 h-3" />
                            </motion.div>
                        </AnimatePresence>
                    </div>
                ...
                <div className="space-y-4">
                    <Button
                        ...
                        variant="primary"
                        size="lg"
                        className="w-full flex items-center justify-center gap-3 py-4 text-base font-bold tracking-wide group"
                    >
                        <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 pointer-events-none" />
                        <svg className="h-5 w-5 relative z-10" aria-hidden="true" viewBox="0 0 24 24">
                            <path
